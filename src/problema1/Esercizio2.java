    ...
    private static void punto5() throws FileNotFoundException {
        ...
        for(int i = 0; i < sequenzeList.size(); i++) {
            ...
            for(int j = i + 1; j < sequenzeList.size(); j++) {
                ...
                writer.print(sequenza1.getNome() + "-" + sequenza2.getNome() + ",");

                for(String parola : sequenza1.getStringhe()) {
                    writer.print(parola + ",");
                }

                for(String parola : sequenza2.getStringhe()) {
                    if(!sequenza1.getStringhe().contains(parola)) {
                        writer.print(parola + ",");
                    }
                }
